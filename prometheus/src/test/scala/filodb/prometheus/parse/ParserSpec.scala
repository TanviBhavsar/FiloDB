...
class ParserSpec extends AnyFunSpec with Matchers {
  ...
  it("Should be able to make logical plans for Series Expressions") {
    val queryToLpString = Map(
      ...
      """sum(rate(my_hist_buckets{job="prometheus"}[10m])) by (le)""" -> "Aggregate(Sum,PeriodicSeriesWithWindowing(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist_buckets))),List(),Some(600000),None),1524855988000,1000000,1524855988000,600000,Rate,false,List(),None,List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist_buckets)))),List(),List(le),List())",
      """sum(rate(my_hist{job="prometheus"}[10m]))""" -> "Aggregate(Count,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None),List(),List(),List())"
//      """count(my_hist_buckets{job="prometheus"})""" -> "Aggregate(Count,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist_buckets))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None),List(),List(),List())",
//      """count(my_hist{job="prometheus"})""" -> "Aggregate(Count,PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None),List(),List(),List())"
//    """my_hist_buckets{job="prometheus",le="0.5"}""" -> "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(le,Equals(0.5)), ColumnFilter(__name__,Equals(my_hist_buckets))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None)" ,
//    """my_hist_buckets{job="prometheus",_bucket_="0.5"}""" -> "ApplyInstantFunction(PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist_buckets))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None),HistogramBucket,List(ScalarFixedDoublePlan(0.5,RangeParams(0,9223372036854775807,60000))))"

//      """my_hist::sum{job="prometheus"}""" -> "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist))),List(sum),Some(300000),None),1524855988000,1000000,1524855988000,None)",
//      """my_hist_sum{job="prometheus"}""" ->             "PeriodicSeries(RawSeries(IntervalSelector(1524855988000,1524855988000),List(ColumnFilter(job,Equals(prometheus)), ColumnFilter(__name__,Equals(my_hist_sum))),List(),Some(300000),None),1524855988000,1000000,1524855988000,None)"
